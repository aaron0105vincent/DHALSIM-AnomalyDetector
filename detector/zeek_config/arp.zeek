...
event zeek_init() &priority=5
{
  ...
  # Force creation of arp.log file even if no ARP traffic occurs
  # Write a dummy entry that can be filtered out
  local dummy_info: Info;
  dummy_info$ts = network_time();
  dummy_info$operation = "init";
  dummy_info$src_mac = "00:00:00:00:00:00";
  dummy_info$dst_mac = "00:00:00:00:00:00";
  dummy_info$orig_h = 0.0.0.0;
  dummy_info$resp_h = 0.0.0.0;
  dummy_info$orig_hw = "00:00:00:00:00:00";
  dummy_info$resp_hw = "00:00:00:00:00:00";
  
  Log::write(ARP::LOG, dummy_info);
}
